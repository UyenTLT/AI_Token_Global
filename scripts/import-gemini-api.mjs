// scripts/import-gemini-api.mjs
//
// Parses archive/gemini-api.html and produces a Sanity NDJSON document for the
// `apiModelPage` document type (English, modelSlug: gemini).
//
// Usage from repo root:
//   node scripts/import-gemini-api.mjs
//
// Import to Sanity:
//   cd studio && npx sanity dataset import ../scripts/data/geminiApiPage-en.ndjson production --replace

// ── Config ─────────────────────────────────────────────────────────────
const MODEL_SLUG     = 'gemini';
const HERO_ACCENT    = 'blue';
const DOC_ID         = 'apiModelPage-gemini-en';
const HTML_PATH      = 'archive/gemini-api.html';
const OUTPUT_PATH    = 'scripts/data/geminiApiPage-en.ndjson';
...
// Unique section — "Who Is It Particularly Well-Suited For?"
...
// ── SEO defaults ────────────────────────────────────────────────────────
const seo = {
  seoTitle: 'Gemini API Guide — Multimodal Capabilities, Pricing & Token Costs',
  seoDescription:
    'Understand the Gemini API by Google: multimodal design, Google ecosystem integration, pricing tiers, and how to evaluate it vs ChatGPT and Claude.',
  noindex: false,
};
